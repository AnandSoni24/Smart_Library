...
<body>
	...
	<h1>SMART LIBRARY</h1>
	<h6 style="font-size: 24px; color: #ffffff; text-align: center; font-family: Arial, sans-serif; margin-top: 20px;">
    		A Complete Library Management and ID Card Maker Website.
	</h6>
		<br>
	<div class="container">
	...
	<div class="footer w3layouts agileits">
		<p> &copy; 2024 Developed by Riya Lodha & Anand Soni.All rights reserved. </a></p>
